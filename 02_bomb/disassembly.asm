...
0000000000400efc <phase_2>:
  ...
  400f0e:	74 20                	je     400f30 <phase_2+0x34>        # Check if the input contains six numbers
...
0000000000400f43 <phase_3>:
  ...
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>        # If ==, Skip <explode_bomb>
  400f65:	e8 d0 04 00 00       	call   40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)               # ?? What's it for IDK
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>        
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eaxi              
...
0000000000400fce <func4>:
  400fce:	48 83 ec 08          	sub    $0x8,%rsp                    # Allocate 8 bytes on stack
  400fd2:	89 d0                	mov    %edx,%eax 
  400fd4:	29 f0                	sub    %esi,%eax                    # result = @arg3 - @arg2 (14)
  400fd6:	89 c1                	mov    %eax,%ecx                    # %ecx = result (14)
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx                   # %ecx >> 31
  400fdb:	01 c8                	add    %ecx,%eax                    # result += %ecx
  400fdd:	d1 f8                	sar    $1,%eax                      
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx           # %ecx = (result/2 + @arg2)
  400fe2:	39 f9                	cmp    %edi,%ecx                    
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24>          # If @arg4 <= @arg1 goto <Here!>
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx
  400fe9:	e8 e0 ff ff ff       	call   400fce <func4>
  400fee:	01 c0                	add    %eax,%eax
  400ff0:	eb 15                	jmp    401007 <func4+0x39>
  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax                    # Here! 
  400ff7:	39 f9                	cmp    %edi,%ecx                   
  400ff9:	7d 0c                	jge    401007 <func4+0x39>          # If @arg4 >= @arg1 return 0
  400ffb:	8d 71 01             	lea    0x1(%rcx),%esi               # @arg2 = @arg4 + 1
  400ffe:	e8 cb ff ff ff       	call   400fce <func4>               # Recurse
  401003:	8d 44 00 01          	lea    0x1(%rax,%rax,1),%eax        # result = rv + rv
...
000000000040100c <phase_4>:
  ...
  40102c:	75 07                	jne    401035 <phase_4+0x29>            # SI contains 2 numbers
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp)                   
  401033:	76 05                	jbe    40103a <phase_4+0x2e>            # SI @input1 is <= 14 
  401035:	e8 00 04 00 00       	call   40143a <explode_bomb>
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx                        # @arg3 = 14
  40103f:	be 00 00 00 00       	mov    $0x0,%esi                        # @arg2 = 0
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi                   # @arg1 = @input1
  401048:	e8 81 ff ff ff       	call   400fce <func4>
  40104d:	85 c0                	test   %eax,%eax
  40104f:	75 07                	jne    401058 <phase_4+0x4c>            # SI <func4> returns 0
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp)
  401056:	74 05                	je     40105d <phase_4+0x51>            # SI @input2 == 0
...
0000000000401062 <phase_5>:
  ...
  401067:	48 89 fb             	mov    %rdi,
  40106a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
  401071:	00 00 
  401073:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
  401078:	31 c0                	xor    %eax,%eax
  40107a:	e8 9c 02 00 00       	call   40131b <string_length>
  40107f:	83 f8 06             	cmp    $0x6,%eax                        # SI input contains 6 characters     
  401082:	74 4e                	je     4010d2 <phase_5+0x70>
  401084:	e8 b1 03 00 00       	call   40143a <explode_bomb>
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>
# start here
  40108b:	0f b6 0c 03          	movzbl (,%rax,1),%ecx                   # %ecx = character       
  40108f:	88 0c 24             	mov    %cl,(%rsp)                       # (%rsp) = character
  401092:	48 8b 14 24          	mov    (%rsp),%rdx                      # Read 8-bytes data after %rsp
  401096:	83 e2 0f             	and    $0xf,%edx                        # %edf = (0x0 ~ 0xf)
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx              # map to the mystery string "aduie......"
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1)            # replace our string with converted character
...
00000000004010f4 <phase_6>:
  ...
  4010f8:	41 54                	push   %r12                             # Init %r12 = i
  4010fa:	55                   	push   %rbp
  4010fb:	53                   	push   %rbx
  4010fc:	48 83 ec 50          	sub    $0x50,%rsp

  401100:	49 89 e5             	mov    %rsp,%r13
  401103:	48 89 e6             	mov    %rsp,%rsi                        # @arg2 = %rsp
  401106:	e8 51 03 00 00       	call   40145c <read_six_numbers>
  40110b:	49 89 e6             	mov    %rsp,%r14                        # %r14 = %rsp
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d                       # i = 0
.L3: # Verify user's input
# for (int i = 0; i < 6; i++)
  401114:	4c 89 ed             	mov    %r13,%rbp                        # %rbp = %rsp
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax                   # result = (%rsp)
  40111b:	83 e8 01             	sub    $0x1,%eax                        # result -= 1
  40111e:	83 f8 05             	cmp    $0x5,%eax                        # --
  401121:	76 05                	jbe    401128 <phase_6+0x34>            # SI result <= 5
  401123:	e8 12 03 00 00       	call   40143a <explode_bomb>            # --
  401128:	41 83 c4 01          	add    $0x1,%r12d                       # i += 1
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d                       # --
  401130:	74 21                	je     401153 <phase_6+0x5f>            # If (i == 6) then goto .L1
  401132:	44 89 e3             	mov    %r12d,%ebx                       # --
.L2:
  401135:	48 63 c3             	movslq %ebx,%rax                        # result = i
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax               # result = %rsp + result * 4
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)                   # --
  40113e:	75 05                	jne    401145 <phase_6+0x51>            # SI result == (%rbp)
  401140:	e8 f5 02 00 00       	call   40143a <explode_bomb>            # --
  401145:	83 c3 01             	add    $0x1,%ebx                        # %rbx += 1
  401148:	83 fb 05             	cmp    $0x5,%ebx                        # --
  40114b:	7e e8                	jle    401135 <phase_6+0x41>            # If (%rbx <= 5) goto .L2
  40114d:	49 83 c5 04          	add    $0x4,%r13                        # %r13 += 4
  401151:	eb c1                	jmp    401114 <phase_6+0x20>            # goto .L3
.L1:
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi                  # @arg2 = %rsp + 24
  401158:	4c 89 f0             	mov    %r14,%rax                        # result = %r14
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx                        # @arg4 = 7
.L4
  ...
  40116d:	75 f1                	jne    401160 <phase_6+0x6c>            # If (result != @arg2) goto .L4
...
.B3
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2)           # (%rsp + 32 + @arg2 * 2) = @arg3
  40118d:	48 83 c6 04          	add    $0x4,%rsi                        # @arg2 += 4:
...
.B
  ...
  4011e9:	e8 4c 02 00 00       	call   40143a <explode_bomb>            # We explode at here
.B
  4011ee:	48 8b 5b 08          	mov    0x8(%rbx),%rbx
  4011f2:	83 ed 01             	sub    $0x1,%ebp                        # SI %ebp == 1
...
000000000040145c <read_six_numbers>:
  ...
  401460:	48 89 f2             	mov    %rsi,%rdx                            # @arg3 = %rsi
  401463:	48 8d 4e 04          	lea    0x4(%rsi),%rcx                       # @arg4 = %rsi + 4
  401467:	48 8d 46 14          	lea    0x14(%rsi),%rax                      # --
  40146b:	48 89 44 24 08       	mov    %rax,0x8(%rsp)                       # (%rsp + 8) = %rsi + 0x14 (20)
  401470:	48 8d 46 10          	lea    0x10(%rsi),%rax                      # --
  401474:	48 89 04 24          	mov    %rax,(%rsp)                          # (%rsp) = %rsi + 0x10 (16)
  401478:	4c 8d 4e 0c          	lea    0xc(%rsi),%r9                        # @arg6 = %rsi + 12
  40147c:	4c 8d 46 08          	lea    0x8(%rsi),%r8                        # @arg5 = %rsi + 8
